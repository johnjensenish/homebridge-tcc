...
function toHb(thermostat) {
  ...
  response.OutsideTemperature = thermostat.UI.OutdoorTemperatureAvailable ? toCelcius(thermostat.UI.OutdoorTemp, thermostat) : null;
  ...
  response.OutsideHumidity = thermostat.UI.OutdoorHumidityAvailable ? thermostat.UI.OutdoorHumidity : null;
  response.InsideHumidity = thermostat.UI.IndoorHumiditySensorAvailable ? thermostat.UI.IndoorHumidity : null;
